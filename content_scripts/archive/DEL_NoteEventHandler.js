...
function DELsave_new_note(event) {
    console.debug("browsersolutions #save_new_note");
    console.debug(event);
    ...
    try {
        ...
        if (uuid == null || uuid == "") {
            ...
            chrome.runtime.sendMessage({
                ...
                // create new ones
 // modify display stuas of object on the note. Additional buttons should be made visible now
            ...
            console.log("browsersolutions. uuid already set - Do not create new note when it exists already");
        }
    } catch (e) {
        console.error(e);
    }
