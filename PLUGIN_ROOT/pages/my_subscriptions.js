...
if (isValid){
  ...
  const table_columns_to_not_display_keyname = "mysubscriptions_hide_columns";
  ...
  document.getElementById('toggle-name').addEventListener('change', function () {
      toggleColumn('name', this.checked,"subscriptionTable", table_columns_to_not_display_keyname);
  });
  
  document.getElementById('toggle-description').addEventListener('change', function () {
      toggleColumn('description', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
  });
  

  document.getElementById('toggle-active').addEventListener('change', function () {
      toggleColumn('active', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
  });
  document.getElementById('toggle-subscribedate').addEventListener('change', function () {
      toggleColumn('subscribedate', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
  });
  
  document.getElementById('toggle-creatordisplayname').addEventListener('change', function () {
      toggleColumn('creatordisplayname', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
  });
  
 
document.getElementById('toggle-postcount').addEventListener('change', function () {
    toggleColumn('postcount', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
});
document.getElementById('toggle-status').addEventListener('change', function () {
    toggleColumn('status', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
});

document.getElementById('toggle-actions').addEventListener('change', function () {
    toggleColumn('actions', this.checked,"subscriptionTable", table_columns_to_not_display_keyname );
});
  

// setup table items for sorting and filtering
setupTableFilteringAndSorting("subscriptionTable");
...
not_show_by_default_columns.forEach(column => {
    toggleColumn(column, false,"subscriptionTable", table_columns_to_not_display_keyname);
...
async function addSubscriptionByUUID(distributionlistid, feed_data) {
    ...
    try {
        ...
        const tableBody = document.querySelector('table[name="subscriptionTable"]')
...
try {
    return new Promise(
        ...
        chrome.storage.local.get([plugin_uuid_header_name, plugin_session_header_name]).then(function (result) {
            ...
            // Get table body element
            const tableBody = document.querySelector('table[name="subscriptionTable"]').getElementsByTagName('tbody')[0];
...
function DELETEsortTable(colheader) {
    ...
    const table = document.querySelector('table[name="subscriptionTable"]');
...
async function activateAllSubscriptions() {
    ...
    try {
        ...
        const checkboxes = document.querySelector('table[name="subscriptionTable"]').querySelectorAll('input[type="checkbox"]');
