...
try{
 userid = await get_username_from_sessiontoken(session.yellownotes_session);
    ...
    if (userid == null) {
        ...
        document.getElementById("loginlogout").innerHTML =  '<a href="http://www.yellownotes.xyz/loginpage">login</a>' ;
...
document.getElementById("login_status").textContent =  userid ;
       ...
       console.log(d  );
        ...
        document.getElementById("loginlogout").innerHTML =  '<a href="http://www.yellownotes.xyz/logout_silent">logout</a>' ;
