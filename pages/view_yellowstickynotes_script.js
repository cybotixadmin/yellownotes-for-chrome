...
const URI_plugin_user_get_all_yellowstickynotes = "/plugin_user_get_all_yellowstickynotes";
const URI_plugin_user_delete_yellowstickynote = "/plugin_user_delete_yellowstickynote";

const URI_plugin_user_get_abstracts_of_all_yellowstickynotes = "/plugin_user_get_abstracts_of_all_yellowstickynotes";
...
async function deleteDataRow(uuid) {
    try {
        ...
        const installationUniqueId = (await browser.storage.local.get(['installationUniqueId'])).installationUniqueId;

        console.log(installationUniqueId);
        // Fetch data from web service (replace with your actual API endpoint)
        const response = await fetch(server_url + URI_plugin_user_delete_yellowstickynote, {
                method: 'POST',
                headers: {
...
function fetchData() {
    try {
       ...
       // const installationUniqueId = (await browser.storage.local.get(['installationUniqueId'])).installationUniqueId;
        ...
        console.log(installationUniqueId);
        // Fetch data from web service (replace with your actual API endpoint)
        return fetch(server_url + URI_plugin_user_get_all_yellowstickynotes, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
var installationUniqueId = "";
    ...
    browser.storage.local.get(['installationUniqueId']).then(function (result) {
        console.log(result);
        console.log(installationUniqueId);
        return   fetch(server_url + URI_plugin_user_get_all_yellowstickynotes, {
            method: 'POST',
        ...
        data.forEach(row => {
           ...
           // cell7.textContent = 'yellowstickynote=%7B%22url%22%3A%22file%3A%2F%2F%2FC%3A%2Ftemp%2F2.html%22%2C%22uuid%22%3A%22%22%2C%22message_display_text%22%3A%22something%22%2C%22selection_text%22%3A%22b71-4b02-87ee%22%2C%22posx%22%3A%22%22%2C%22posy%22%3A%22%22%2C%22box_width%22%3A%22250%22%2C%22box_height%22%3A%22250%22%7D=yellowstickynote';    
...
// check for visibility
    ...
    render().then(function(d){
        ...
        var note_template = null;
         ...
         fetch(browser.runtime.getURL('stickynotetemplate.html')).
