...
function loadFromIndexedDBbyIndex_async(dbName, storeName, use_index , value) {
    // console.debug("loadFromIndexedDB: 0 ");
    console.debug("loadFromIndexedDBbyIndex_async: 1 " + dbName);
    console.debug("loadFromIndexedDBbyIndex_async: 2 " + storeName);
    console.debug("loadFromIndexedDBbyIndex_async: 3 " + use_index);
    console.debug("loadFromIndexedDBbyIndex_async: 4 " + value);
...
console.debug("2.0.2");
                try {
                    ...
                    var objectRequest = objectStore.index('url').get(value);
                 	console.debug("2.0.3");
...
// var parentArray = [["sourceDomainPolicyDB","sourceDomainPolicyStore"],["sourceHostnamePolicyDB","sourceHostnamePolicyStore"],["sourceURLPolicyDB","sourceURLPolicyStore"]];
    ...
    try {
        ...
        .then(function(values){
            ...
            download_file("yellow_stickynotes_backup.json", JSON.stringify(values));
